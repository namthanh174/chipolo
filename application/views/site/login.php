            ...
            <div class="container-fluid">
                <div class="row text-center">
                    ...
                    <div class="col-xs-12 login-header">
                        <div class="spacer">
                            <h1>Sign in to Chipolo Community</h1>
                            <h3>Find your phone, tablet or Chipolo</h3>

                            <div class="container">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <p>You take your devices everywhere. Which means you might leave them anywhere. Whether they’re at the office in a conference room or under a pillow on your couch, with Chipolo Web app, chances are they won’t be lost for long.</p>
