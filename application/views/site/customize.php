...
<div class="container">
    ...
    <form action="/shop/customize/<?php echo $product->id;?>" method="post" name="frm-shopping" >
        <div class="row spacer">
            ...
            <div class="col-details text-center">
                ...
                <div class="pack-buttons noselect">
                    ...
                    <input type="hidden" value="<?php echo $product->id;?>" name="hid-product-id">
                    <input type="hidden" value="<?php echo $product->title;?>" name="hid-product-name">
                    <input type="hidden" value="<?php echo $product->price;?>" name="hid-product-price">
                    <input type="hidden" value="<?php echo $product->quantity;?>" name="hid-product-qty">
