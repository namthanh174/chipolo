...
<html>
<head>
	<title>Chipolo Shop :: Select your package</title>
	<meta charset="utf-8">
	...
	<meta name="keywords" content="Chipolo, Bluetooth tracker, Bluetooth key finder, find keys with phone, tracking device, track lost keys" />
	...
	<meta property="og:image" content="https://chipolo.net/static/img/favicon_facebook.png"/>
	<meta property="og:description" content="Chipolo™ is a revolutionary new product that helps you keep an eye on your valuables. Whether keeping track of your phone, keys or even your pets, Chipolo™ will help protect the things you love most. Simply attach it to the item of your choice and you’re ready to go. Chipolo™. Nothing is lost."/>

	<!-- Twitter Meta -->
	<meta name="twitter:card" content="summary">
	<meta name="twitter:site" content="@chipoloTM">
	<meta name="twitter:title" content="Chipolo :: Nothing is lost">
	<meta name="twitter:description" content="Chipolo™ is a revolutionary new product that helps you keep an eye on your valuables. Whether keeping track of your phone, keys or even your pets, Chipolo™ will help protect the things you love most. Simply attach it to the item of your choice and you’re ready to go. Chipolo™. Nothing is lost.">
	<meta name="twitter:creator" content="@chipoloTM">
	<meta name="twitter:image:src" content="https://chipolo.net/static/img/chipolo_text.png">
	<meta name="twitter:domain" content="chipolo.net">

	<link rel="apple-touch-icon" href="https://chipolo.net/static/img/favicon_apple.png">
	<link rel="icon" href="https://chipolo.net/static/img/favicon.ico" sizes="16x16 32x32 64x64 128x128" type="image/vnd.microsoft.icon">

	<!-- Bootstrap Core CSS -->
	<link href="<?php echo base_url(); ?>assets/site/css/bootstrap.min.css" rel="stylesheet">
	<!-- Custom CSS -->
	<link href="<?php echo base_url(); ?>assets/site/css/chipolo_shop.css" rel="stylesheet">
	...
	<![endif]-->
	<script src="<?php echo base_url(); ?>assets/site/js/jquery_1.11.0.js"></script>

	
	<link href="<?php echo base_url(); ?>assets/site/css/ext/cookie_consent.css" rel="stylesheet" />
	<script src="<?php echo base_url(); ?>assets/site/js/ext/cookie_consent.js"></script>
	...
	(function(h,o,t,j,a,r){
		...
		(function()
		{ var nm = document.createElement('script'); nm.type = 'text/javascript'; nm.async = true; nm.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + '40nuggets.com/widget/js/track/track-'+_40nmcid+'.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(nm,s); }
		)();
...
<body>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/site/js/owl2/assets/owl.carousel.css">
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/site/js/owl2/assets/owl.theme.default.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/site/js/scroller/jquery.scroller.css"/>
<style>
#scroller {
    overflow: hidden;
    height: 510px;
...
.thumb.active { border: 1px solid gray;}
.mTSButton { display: none; }
...
<img src="https://p1.zemanta.com/p/58/colorpicker/" height="1" width="1" border="0" alt="" />
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/site/js/scroller/jquery.scroller.min.js"></script>
...
<script>/*<![CDATA[*/window.zEmbed||function(e,t){var n,o,d,i,s,a=[],r=document.createElement("iframe");window.zEmbed=function(){a.push(arguments)},window.zE=window.zE||window.zEmbed,r.src="javascript:false",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="display: none",d=document.getElementsByTagName("script"),d=d[d.length-1],d.parentNode.insertBefore(r,d),i=r.contentWindow,s=i.document;try{o=s}catch(c){n=document.domain,r.src='javascript:var d=document.open();d.domain="'+n+'";void(0);',o=s}o.open()._l=function(){var o=this.createElement("script");n&&(this.domain=n),o.id="js-iframe-async",o.src=e,this.t=+new Date,this.zendeskHost=t,this.zEQueue=a,this.body.appendChild(o)},o.write('<body onload="document._l();">'),o.close()}("https://assets.zendesk.com/embeddable_framework/main.js","chipolo.zendesk.com"); /*]]>*/</script>
